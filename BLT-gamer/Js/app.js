...
(function () {
  ...
  /* ============================================================
     TEMA (dark/light) — só preferência visual, persistida no navegador.
     ============================================================ */
  (function tema() {
    var salvo = localStorage.getItem('bl-tema');
    ...
    document.querySelectorAll('#blThemeToggle, .bl-theme-toggle').forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        if (claro) {
          ...
          localStorage.setItem('bl-tema', 'dark');
        } else {
          document.documentElement.setAttribute('data-theme', 'light');
          localStorage.setItem('bl-tema', 'light');
        }
        atualizarIcone();
      });
    });
  ...
  /* ============================================================
     SOM — desligado por padrão; ativa só após interação do usuário.
     ============================================================ */
  var somAtivo = localStorage.getItem('bl-som') === 'on';
  var audioCtx = null;
  function tocarBip(freq, duracao) {
    ...
    } catch (e) { /* silencioso: áudio é só um extra */ }
  }
  document.querySelectorAll('#blSomToggle').forEach(function (btn) {
  ...
  if (!prefersReducedMotion && window.matchMedia('(pointer:fine)').matches) {
    ...
    document.documentElement.classList.add('bl-has-cursor');
    ...
    document.querySelectorAll('a, button, .bl-card, input, [role="button"]').forEach(function (el) {

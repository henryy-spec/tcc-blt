...
<title>Blue Light Team | Plataforma de Jogos</title>
</head>
<body>
...
<footer class="bl-footer" id="contato">
  <div class="container">
    <div>© 2026 Blue Light Team. Todos os direitos reservados.</div>
...
<section class="bl-hero" id="inicio">
    ...
    <div class="container">
        ...
        <div>
            ...
            <span class="bl-hero-eyebrow">
                <i class="fa-solid fa-bolt"></i>
                Plataforma de jogos premium
            </span>

            <h1>
                JOGUE SEM <span>LIMITES</span>, DE ONDE ESTIVER
            </h1>

            <p>
                Crie sua conta, escolha um plano e tenha acesso instantâneo
                a jogos, conquistas e uma biblioteca que evolui com você.
            </p>
            ...
            <div class="bl-hero-ctas">
                ...
                <a
                    class="bl-btn bl-btn-ghost"
                    href="<?= $logado ? '#planos' : 'entrar.php' ?>"
                >
            ...
            <form
                class="bl-search"
                role="search"
                onsubmit="event.preventDefault(); pesquisar();"
            >
                ...
                <input
                    ...
                    onkeydown="if(event.key==='Enter'){event.preventDefault(); document.getElementById('pesquisa').value=this.value; pesquisar();}"
                >

                <button
                    type="submit"
                    aria-label="Buscar"
                    onclick="document.getElementById('pesquisa').value=document.getElementById('pesquisa-hero').value;"
                >
        ...
        <div class="bl-hero-visual bl-reveal">
            ...
            <img
                src="img/darkhouse.jpg"
                alt="Cena do jogo Chronocide"
            >
...
<section class="bl-section" id="jogos">
    ...
    <div class="container">
        ...
        <div class="bl-section-head bl-reveal">
            ...
            <p class="bl-section-sub">
                Explore o universo de Chronocide através de diferentes cenários.
            </p>
        ...
        <div class="bl-cards">
            ...
            <article
                class="bl-card bl-game-card jogo-card <?= $logado ? '' : 'is-locked' ?> bl-reveal"
                data-cat="aventura"
            >

                <div class="bl-badges">

                    <span class="bl-badge bl-badge-popular">
                        <i class="fa-solid fa-fire"></i>
                        Popular
                    </span>
                ...
                <?php if ($logado): ?>
                    ...
                    <button
                        class="bl-fav-heart <?= $favChronocide ? 'is-active' : '' ?>"
                        type="button"
                        data-bl-fav="chronocide"
                        aria-pressed="<?= $favChronocide ? 'true' : 'false' ?>"
                        aria-label="Favoritar Chronocide"
                    >
                        <i class="fa-<?= $favChronocide ? 'solid' : 'regular' ?> fa-heart"></i>
                    </button>
                ...
                <div class="bl-body">
                    ...
                    <p>
                        Viagem no tempo e aventura em cenários inexplorados.
                    </p>

                    <a
                        class="bl-btn bl-btn-outline"
                        href="<?= $logado ? 'jogar.php' : 'entrar.php' ?>"
                    >
                        Jogar agora
                    </a>
                ...
                <?php if (!$logado): ?>
                    ...
                    <div class="bl-locked-overlay">

                        <i class="fa-solid fa-lock"></i>

                        <span>
                            Requer conta e assinatura
                        </span>
            ...
            >
                ...
                <div class="bl-badges">
                    ...
                    <span class="bl-badge bl-badge-new">
                ...
                <div class="bl-body">
                    ...
                    <p>
                        Ação em diferentes épocas da história.
                    </p>
            ...
            <article
                class="bl-card bl-game-card jogo-card <?= $logado ? '' : 'is-locked' ?> bl-reveal"
                data-cat="misterio premium"
            >

                <div class="bl-badges">

                    <span class="bl-badge bl-badge-ok">
                ...
                <div class="bl-thumb">
                    ...
                    <img
                        src="img/hidden.jpeg"
                        alt="Chronocide — Mistérios do tempo"
                    >
                ...
                <div class="bl-body">
                    ...
                    <p>
                        Explore os mistérios escondidos entre as eras.
                    </p>
            ...
            >
                ...
                <p style="margin:0;">
                    Nenhum jogo encontrado nessa categoria.
                </p>
...
<section class="bl-section">
    ...
    <div class="container">
        ...
        <div
            class="bl-banner bl-reveal"
            data-bl-carousel
        >

            <a
                class="bl-slide active"
                href="<?= $logado ? 'jogar.php' : 'entrar.php' ?>"
            >

                <img
                    src="img/darkhouse.jpg"
                    alt="Chronocide — destaque"
                >
                ...
                <div class="bl-slide-text">
                    ...
                    <p>
                        Uma jornada através do tempo à espera de ser desvendada.
                    </p>

                    <span class="bl-btn bl-btn-primary">
                        <?= $logado ? 'Jogar agora' : 'Entrar para jogar' ?>
                    </span>
            ...
            >
                ...
                <div class="bl-slide-text">
                    ...
                    <p>
                        Explore ilhas perdidas em diferentes períodos da história.
                    </p>
...
<section class="bl-section" id="planos">
    ...
    <div class="container">
        ...
        <div class="bl-plan-grid">
            ...
            <?php foreach ($planos as $slug => $p): ?>

                <div
                    class="bl-card bl-plan <?= $p[5] ? 'is-recommended' : '' ?> bl-reveal"
                >

                    <?php if ($p[5]): ?>

                        <span class="bl-plan-tag">
                            Mais escolhido
                        </span>
                    ...
                    <a
                        class="neymar"
                        href="<?= $logado ? 'pagamento.php?plano=' . e($slug) : 'entrar.php' ?>"
                    >

                        <button
                            class="bl-btn <?= $p[5] ? 'bl-btn-primary' : 'bl-btn-ghost' ?>"
                            type="button"
                        >
                            Contratar
                        </button>
    ...
    <div class="container">
        ...
        <div class="bl-benefits bl-reveal">
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Jogue direto do navegador, sem downloads pesados.
                </p>
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Desbloqueie badges à medida que avança na plataforma.
                </p>
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Assinaturas registradas com confirmação protegida.
                </p>
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Prioridade de atendimento conforme seu plano.
                </p>
    ...
    <div class="container">
        ...
        <div class="bl-cards bl-reveal">
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Assine seu primeiro plano e desbloqueie essa conquista.
                </p>
            ...
            <div class="bl-card bl-benefit">
                ...
                <p>
                    Abra qualquer jogo da biblioteca pela primeira vez.
                </p>
            ...
            <div class="bl-card bl-benefit">
                ...
                <a
                    class="bl-btn bl-btn-outline"
                    href="<?= $logado ? 'php/conquistas.php' : 'entrar.php' ?>"
                >
...
>
    ...
    <div class="container">
        ...
        <div>
            © 2026 Blue Light Team. Todos os direitos reservados.
        </div>
        ...
        <div class="bl-footer-links">
            ...
            <a
                href="<?= $logado ? 'php/perfil.php' : 'login.php' ?>"
            >
                <?= $logado ? 'Minha conta' : 'Criar conta' ?>
            </a>
...
<a
    href="https://wa.me/5511999999999?text=Ola%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es"
...
<script>
window.BL_CSRF = <?= json_encode(csrfToken()) ?>;
</script>
...
function pesquisar() {
    ...
    const semResultado =
        document.getElementById('blSemResultado');

...
.bl-game-audio{width:38px;height:38px;border:1px solid rgba(255,255,255,.16);border-radius:50%;background:rgba(5,8,16,.75);color:#fff;cursor:pointer;display:grid;place-items:center}
.bl-game-audio:hover{background:rgba(59,130,246,.28)}
.bl-game-loading{
...
<div class="bl-game-shell">
  <div class="bl-game-topbar">
    ...
    <div style="display:flex;align-items:center;gap:8px;">
      ...
      <button id="blSomToggle" class="bl-game-audio" type="button" aria-label="Desativar som" title="Desativar som"><i class="fa-solid fa-volume-high"></i></button>
    </div>
  </div>
